...
$sql = "SELECT * FROM srcTab";
$result = mysql_query($sql) or die(mysql_error());

$sources = array();
while ($row = mysql_fetch_assoc($result))
{
	$sources[$row['srcID']] = $row['srcName'];
}
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="row">
                <div class="col-lg-12">
                <h2>Please Enter Customer's Information</h2>
<form class="form-horizontal" action="customer_action.php" method="get" name="form1" onSubmit="MM_validateForm('fname','','R','lname','','R','address','','R','city','','R','state','','R','zip','','RisNum','email','','RisEmail','phone','','RisNum');return document.MM_returnValue">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
    	<input name="cusStreet" class="form-control" type="text" id="cusStreet" value="<?php echo $cusStreet;?>" size="35" maxlength="35"></div>
  </div>
  <div class="form-group">
  	<label class="col-sm-2 control-label">Zip</label>
    <div class="col-sm-1">
    <input name="cusZip" class="form-control" type="text" id="cusZip" value="<?php echo $cusZip;?>" size="8" maxlength="5">
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-4">
        ...
        <div class="radio">
        <label>
          <input type="radio" name="cusSex" <?php if ($cusSex == "f") {echo ' checked=checked ';} ?> value="f" >
          Female</label>
        </div><div class="radio">
		<label>
          <input name="cusSex" type="radio" <?php if ($cusSex == "u") {echo ' checked=checked ';} ?> value="u" >
          Other</label>
          </div>
    </div>
  </div>
  	...
  	<div class="col-sm-4">
  		<select name="cusSource">
  			...
  			foreach ($sources as $key => $value) { 
  				$checked = ($key == $cusSource) ? " selected=\"selected\"" : "";
  				echo sprintf("<option value=\"%d\"%s>%s</option>", $key, $checked, $value) . "\n";
  			}
  			?>
  		</select>
  	</div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-1">
    	<input name="cusAge" class="form-control" type="text" id="cusAge" value="<?php echo $cusAge;?>" size="5" maxlength="2">
  </div></div>
  <div class="form-group">
  	<label class="col-sm-2 control-label">Birthday</label>
    <div class="col-sm-4">
    <label><input name="cusBirth" class="form-control" type="date" id="cusBirth" value="<?php echo $cusBirth; ?>" size="10" maxlength="8"> <!--mmddyyyy --></label>
    </div></div>
  <div class="form-group">
  	<label class="col-sm-2 control-label">Comment</label>
    <div class="col-sm-4">
    <textarea name="cusComment" class="form-control" id="cusComment" cols="45" rows="3"><?php echo $cusComment;?></textarea>
  </div></div>
 ...
 <!--
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
    <label><input name="date" class="form-control" type="date" id="date" value="" size="10">(MM-DD-YYYY)</label>
  </div></div>
  <div class="form-group">
  	<label class="col-sm-2 control-label">Updated</label>
    <div class="col-sm-4">
    <label><input name="cusUpdated" class="form-control" type="text" id="cusUpdated" value="" size="10">(MM-DD-YYYY)</label>
    </div>
  </div>
  -->
  ...
  <div class="form-group">
      ...
      <input class="btn btn-sunset" type="submit" name="Submit" value="Submit">
      <a class="btn btn-sunset" role="button" href="index.php">Return</a>
</div></div>
</form>
                     </div>
                </div>
