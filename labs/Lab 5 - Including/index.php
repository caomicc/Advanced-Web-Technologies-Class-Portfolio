    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item"><a href="index.php">Lab 5 - Including</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="row">
                <div class="col-lg-12">
                    <h2>Includes  <small>Lab 5</small></h2><br>
                    <form name="includeform" method="get" action="funkyclass5.php" class="form-horizontal">
