    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item"><a href="index.php">Lab 6 - Cookies</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="row">
                <div class="col-lg-12">
                		 <h2>Cookies <small>Lab 6</small></h2><br>
                    <form name="cookiesform" method="get" action="eatingallmycookies.php" class="form-horizontal">
  				   <div class="form-group">
                   <label  class="col-md-2 control-label"for="cookiesName">What type of cookie would you like? </label>
				   <div class="col-md-4">
