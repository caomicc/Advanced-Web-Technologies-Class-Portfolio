...
<!--<script type="text/javascript">
		<!--
			window.onload = function() {
				window.location = "studentlist.xml";
			};
		-->
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="row">
                <div class="col-lg-12">
<h2>XML <small>Lab 11</small></h2><br>
...
<script language="JavaScript">
  ...
  // send the request.
  Connect.open("GET", "studentlist.xml", false);
  ...
  for (var i = 0; i < Customers.children.length; i++)
  {
   ...
   var Age = Customer.getElementsByTagName("ssn");
   ...
   document.write(ssn[0].textContent.toString());
   document.write("</td><td>");
   document.write(class[0].textContent.toString());
