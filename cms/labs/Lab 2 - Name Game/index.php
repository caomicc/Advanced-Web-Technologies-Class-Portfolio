...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
          ...
          <ul class="list-group">
            <li class="list-group-item"><a href="index.php">Lab 2 - Name Game</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="row">
                <div class="col-lg-12">
                <h2>Name Game <small>Lab 2</small></h2><br>
                   <form name="form1" method="get" action="nameGame.php" class="form-horizontal">
  				   		<div class="form-group">
                   <label class="col-md-2 control-label" for="firstName">Tell me, what is your first name?</label>
                   		<div class="col-md-4">
