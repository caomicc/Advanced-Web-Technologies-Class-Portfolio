...
<head>
    ...
    <title>Lab 4 - Celcius Conversions</title>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item"><a href="index.php">Lab 4 - Celcius Conversions</a></li>
            ...
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="col-lg-12">
                    ...
                    <form id="tempform" name="tempform" method="get" action="temp.php" class="form-horizontal">
                    <div class="form-group">
                    <label class="col-md-2 control-label" for="num">Please enter a tempurature! </label>
