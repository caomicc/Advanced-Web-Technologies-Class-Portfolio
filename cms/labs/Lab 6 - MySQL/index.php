        ...
        <!-- Sidebar -->
         <div id="sidebar-wrapper">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item"><a href="index.php">Lab 6 - MySQL</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               <!--<div class="menu-div"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a></div>-->
                ...
                <div class="row">
                <div class="col-lg-12">
                <h2>MySQL Customer Tables <small>Lab 6</small></h2>
...
$query = "SELECT cusID, cusFirst, cusStreet, cusZip, cusLast FROM cusTab";
$result = mysql_query($query);
$num = mysql_num_rows($result);

echo "<table class='table table-hover table-bordered table-striped'><tr><th>Last Name</th><th>First Name</th><th>Address</th><th>Zip</th></tr>";
