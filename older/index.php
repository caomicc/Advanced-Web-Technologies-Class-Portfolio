        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                   ...
                   <form name="form1" method="get" action="../labs/Lab 2 - Name Game/nameGame.php" class="form-horizontal">
                   ...
                   <br><hr><br>
                    ...
                    <form name="planets" method="get" action="../labs/Lab 2 - Favorite Picker/favoriteoptions.php" class="form-horizontal">
 	<h3>Planets</h3>
  <div class="form-group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form name="form2" method="get" action="../labs/Lab 4 - Named Strings/stringy.php" class="form-horizontal">      
 					<div class="form-group">
					...
					<form class="form-horizontal" name="functionform" method="get" action="../labs/Lab 4 - Sign Changes/funky.php">
                    ...
                    <form id="tempform" name="tempform" method="get" action="../labs/Lab 4 - Celcius Conversion/temp.php" class="form-horizontal">
                    <div class="form-group">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form name="includeform" method="get" action="../labs/Lab 5 - Including/funkyclass5.php" class="form-horizontal">
                    ...
                    <a href ="../labs/Lab 5 - Sessions/s1.php">Session #1</a>
					<br>
					<a href ="../labs/Lab 5 - Sessions/s2.php">Session #2</a>
					<br>
					<a href ="../labs/Lab 5 - Sessions/s3.php">Session #3</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form name="cookiesform" method="get" action="../labs/Lab 6 - Cookies/eatingallmycookies.php" class="form-horizontal">
  				   <div class="form-group">
...
?> 
<br><br><p>
Incase you want to view this on another page, you can <a href="../labs/Lab 6 - MySQL/sqlconnect.php">click here!</a></p>
                </div>
            </div>
        </div>
    </section>
...
<a href="../labs/Lab 7 - MySQL Continued/customer_connect.php?action=a">Add a Customer</a>
